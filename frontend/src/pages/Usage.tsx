...
type UsageTableColumn = 'status' | 'model' | 'account' | 'username' | 'priceMultiplier' | 'apiKey' | 'clientIp' | 'userAgent' | 'endpoint' | 'type' | 'token' | 'cost' | 'cached' | 'wsAcquire' | 'timing' | 'tokensPerSec' | 'time'
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      {visibleColumns.timing && renderSortableUsageHead('duration', t('usage.tableTiming'), t('usage.tableTimingHint'))}
