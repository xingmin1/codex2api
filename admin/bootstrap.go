...
func defaultBootstrapSettings() *database.SystemSettings {
	return &database.SystemSettings{
		...
		CheapProbeConcurrency:              2,
		CheapProbeTimeoutSeconds:           30,
		CheapProbeRecoveryMargin:           10,
		CheapProbeBonusDurationMinutes:     10,
		CheapProbeRankBaseIntervalSeconds:  180,
		CheapProbeRankStepSeconds:          30,
		CheapProbeRankMinIntervalSeconds:   30,
		LazyMode:                           false,
		PgMaxConns:                         50,
		RedisPoolSize:                      30,
