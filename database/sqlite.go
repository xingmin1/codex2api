...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS account_quality_eval_batches (
			...
			test_kind TEXT NOT NULL DEFAULT 'full',
			scheduled_hour TIMESTAMP NULL,
			model TEXT NOT NULL,
			reasoning_effort TEXT NOT NULL,
			status TEXT NOT NULL DEFAULT 'running',
			error_message TEXT NOT NULL DEFAULT '',
			juice_requested INTEGER NOT NULL DEFAULT 0,
			juice_concurrency INTEGER NOT NULL DEFAULT 0,
			juice_graded INTEGER NOT NULL DEFAULT 0,
			juice_correct INTEGER NOT NULL DEFAULT 0,
			candy_requested INTEGER NOT NULL DEFAULT 0,
			candy_concurrency INTEGER NOT NULL DEFAULT 0,
			candy_graded INTEGER NOT NULL DEFAULT 0,
			candy_correct INTEGER NOT NULL DEFAULT 0,
		...
		`CREATE TABLE IF NOT EXISTS quality_eval_config (
			...
			lookback_hours INTEGER NOT NULL DEFAULT 5,
			top_accounts INTEGER NOT NULL DEFAULT 5,
			min_requests INTEGER NOT NULL DEFAULT 50,
			batch_concurrency INTEGER NOT NULL DEFAULT 1,
			updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
		);`,
		`CREATE TABLE IF NOT EXISTS quality_eval_schedule_runs (
			scheduled_hour TIMESTAMP PRIMARY KEY,
			status TEXT NOT NULL DEFAULT 'running',
			started_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
			finished_at TIMESTAMP NULL
		);`,
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
				...
				background_refresh_interval_minutes INTEGER DEFAULT 2,
					...
					cheap_probe_enabled INTEGER DEFAULT 1,
					cheap_probe_scan_interval_seconds INTEGER DEFAULT 10,
					cheap_probe_concurrency INTEGER DEFAULT 2,
					cheap_probe_timeout_seconds INTEGER DEFAULT 30,
					cheap_probe_recovery_margin REAL DEFAULT 10,
					cheap_probe_bonus_duration_minutes INTEGER DEFAULT 10,
					cheap_probe_rank_base_interval_seconds INTEGER DEFAULT 180,
					cheap_probe_rank_step_seconds INTEGER DEFAULT 30,
					cheap_probe_rank_min_interval_seconds INTEGER DEFAULT 30,
					cheap_probe_max_multiplier REAL DEFAULT 0,
					dispatch_max_multiplier REAL DEFAULT 0,
					failure_score_threshold INTEGER DEFAULT 3,
					failure_cooldown_threshold INTEGER DEFAULT 10,
					failure_tolerance_window_seconds INTEGER DEFAULT 60,
					failure_score_retroactive INTEGER DEFAULT 0,
				...
				scheduler_mode TEXT DEFAULT 'round_robin',
					...
					transport_retry_policy TEXT DEFAULT 'hybrid',
					transport_same_account_retries INTEGER DEFAULT 2,
					compact_same_account_retries INTEGER DEFAULT 2,
					client_request_replay_enabled INTEGER DEFAULT 1,
					client_request_replay_max_retries INTEGER DEFAULT 5,
					client_request_replay_max_duration_seconds INTEGER DEFAULT 600,
					client_request_replay_retry_base_interval_ms INTEGER DEFAULT 1000,
					client_request_replay_retry_max_interval_seconds INTEGER DEFAULT 30,
					client_request_replay_keepalive_seconds INTEGER DEFAULT 15,
					encrypted_content_compatibility_enabled INTEGER DEFAULT 1,
					fast_tier_policy TEXT DEFAULT 'preserve',
	...
	columns := []struct {
		...
		{"account_quality_eval_batches", "juice_concurrency", "INTEGER NOT NULL DEFAULT 0"},
		{"account_quality_eval_batches", "candy_concurrency", "INTEGER NOT NULL DEFAULT 0"},
		{"account_quality_eval_batches", "error_message", "TEXT NOT NULL DEFAULT ''"},
		{"account_quality_eval_samples", "http_status", "INTEGER NOT NULL DEFAULT 0"},
		{"account_quality_eval_samples", "terminal_status", "TEXT NOT NULL DEFAULT ''"},
		...
		{"system_settings", "cheap_probe_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "cheap_probe_scan_interval_seconds", "INTEGER DEFAULT 10"},
		{"system_settings", "cheap_probe_concurrency", "INTEGER DEFAULT 2"},
		{"system_settings", "cheap_probe_timeout_seconds", "INTEGER DEFAULT 30"},
		{"system_settings", "cheap_probe_recovery_margin", "REAL DEFAULT 10"},
		{"system_settings", "cheap_probe_bonus_duration_minutes", "INTEGER DEFAULT 10"},
		{"system_settings", "cheap_probe_rank_base_interval_seconds", "INTEGER DEFAULT 180"},
		{"system_settings", "cheap_probe_rank_step_seconds", "INTEGER DEFAULT 30"},
		{"system_settings", "cheap_probe_rank_min_interval_seconds", "INTEGER DEFAULT 30"},
		{"system_settings", "cheap_probe_max_multiplier", "REAL DEFAULT 0"},
		{"system_settings", "dispatch_max_multiplier", "REAL DEFAULT 0"},
		{"system_settings", "failure_score_threshold", "INTEGER DEFAULT 3"},
		{"system_settings", "failure_cooldown_threshold", "INTEGER DEFAULT 10"},
		{"system_settings", "failure_tolerance_window_seconds", "INTEGER DEFAULT 60"},
		{"system_settings", "failure_score_retroactive", "INTEGER DEFAULT 0"},
		...
		{"system_settings", "transport_same_account_retries", "INTEGER DEFAULT 2"},
		{"system_settings", "compact_same_account_retries", "INTEGER DEFAULT 2"},
		{"system_settings", "client_request_replay_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "client_request_replay_max_retries", "INTEGER DEFAULT 5"},
		{"system_settings", "client_request_replay_max_duration_seconds", "INTEGER DEFAULT 600"},
		{"system_settings", "client_request_replay_retry_base_interval_ms", "INTEGER DEFAULT 1000"},
		{"system_settings", "client_request_replay_retry_max_interval_seconds", "INTEGER DEFAULT 30"},
		{"system_settings", "client_request_replay_keepalive_seconds", "INTEGER DEFAULT 15"},
		{"system_settings", "encrypted_content_compatibility_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "fast_tier_policy", "TEXT DEFAULT 'preserve'"},
	...
	indexStatements := []string{
		...
		`CREATE INDEX IF NOT EXISTS idx_quality_eval_batches_account_created ON account_quality_eval_batches(account_id, created_at DESC);`,
		`CREATE INDEX IF NOT EXISTS idx_quality_eval_batches_status ON account_quality_eval_batches(status, created_at);`,
		`CREATE INDEX IF NOT EXISTS idx_quality_eval_samples_batch ON account_quality_eval_samples(batch_id, test_kind, sample_index);`,
